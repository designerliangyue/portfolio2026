...
export const zh: Dictionary = {
  ...
  home: {
    ...
    workSerif: ["跨文化规模。"],
    workLede:
      "三个项目展示了我在不同尺度下的工作方式：定义并上线 AI 销售产品，通过覆盖四个市场的远程研究重构区域保险平台，以及把私有云运维任务转译成企业级产品系统。",
    aboutLabel: "关于",
    aboutTitle: [
      "一位以结果为导向的设计师——在可靠性与",
      "创新",
    ...
    timelineItems: [
      {
        period: "2021 — 2026",
        role: "高级产品设计师 · 雅信安",
        note: "负责东南亚保险销售平台的端到端产品设计，覆盖跨市场研究、AI 辅助销售、多角色 SaaS、设计系统，以及与远程产品和工程团队协作交付。"
      },
      {
        period: "2019 — 2021",
        role: "UI/UX 设计师 · 招商银行",
        note: "将私有云运维工作转化为统一的企业控制台，覆盖信息架构、运维流程、交互表格、渐进式引导，以及共享的明暗主题组件系统。"
      },
      {
        period: "2017 — 2019",
        role: "UI/UX 设计师 · 精为科技",
        note: "为制造业客户提供端到端产品咨询，从模糊业务需求与 MVP 范围，推进到流程、原型、界面系统和生产规范。"
      },
      {
        period: "2016 — 2017",
        role: "平面与 UI 设计师 · UnitedStack",
        note: "设计 Web 与移动产品界面及视觉识别系统，在产品和品牌触点之间保持一致体验。"
      }
    ],
    education: "教育",
    educationItems: [
