...
export const zh: Dictionary = {
  ...
  home: {
    ...
    workSerif: ["战略前瞻。"],
    workLede:
      "这三个项目按顺序构成我应聘高级产品设计师的叙事主线：从覆盖四个东南亚市场的区域保险平台，到基于同一洞察构建的 AI 销售副驾驶，再到中国大型银行私有云平台。",
    aboutLabel: "关于",
    aboutTitle: [
      "一位以结果为导向的设计师——在可靠性与",
      "创新",
  ...
  about: {
    ...
    backgroundParagraphs: [
      "我的起点是风景园林——在那里我学会了设计能激发连接、凝聚人的空间。今天，我将同样的热情带入数字产品设计，打造直观、有参与感且有意义的产品体验。过去 7 年多，我横跨保险科技、云计算、银行与服务行业，为真实用户解决真实问题。",
    ...
    timelineItems: [
      ...
      },
      {
        ...
        note: "四个东南亚市场的端到端改版。25 场母语访谈、区域设计体系、四个新模块。"
      },
      {
        period: "2022",
        role: "产品设计师 · 员工福利平台",
  ...
  footer: {
    ...
    title: "一起设计下一步",
    lede:
      "我正在寻找高级产品设计师机会，更倾向全远程工作。拥有 7 年以上跨文化产品经验，深耕保险科技、银行与 AI 增强界面设计。",
    aboutLink: "阅读完整背景 →",
